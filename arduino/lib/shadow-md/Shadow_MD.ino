...
String PS3ControllerFootMAC = "04:76:6E:85:17:FD";  // Set this to your FOOT PS3 controller MAC address
String PS3ControllerDomeMAC = "00:06:F5:B4:F1:E1";  // Set to a secondary DOME PS3 controller MAC address (Optional)
...
byte joystickFootDeadZoneRange = 15;  // For controllers that have centering problems, use the lowest number with no drift
byte joystickDomeDeadZoneRange = 10;  // For controllers that have centering problems, use the lowest number with no drift
